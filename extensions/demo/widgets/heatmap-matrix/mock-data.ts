...
export const demoHeatmapColumns = ["Overnight", "1W", "1M", "3M", "6M", "1Y"] as const;
...
export const demoHeatmapCells: DemoHeatmapCell[] = demoHeatmapRows.flatMap((rowLabel, rowIndex) =>
  demoHeatmapColumns.map((columnLabel, columnIndex) => {
