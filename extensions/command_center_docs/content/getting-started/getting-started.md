...
- Apps group related surfaces in the left navigation.
- Workspaces are editable canvases where users compose widgets into an operating view.
...
3. Add a small set of widgets from the widget catalog.
4. Configure one widget to produce data.
5. Bind downstream widgets to that output.
6. Save the workspace and use it as the operating surface for that task.
...
This documentation is for product usage. Developer documentation, architecture decisions, backend
contracts, and extension implementation details live in the repository developer docs and local
module README files.
