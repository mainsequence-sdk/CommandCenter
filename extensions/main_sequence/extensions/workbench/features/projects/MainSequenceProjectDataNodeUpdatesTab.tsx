...
} from "../data-nodes/MainSequenceDataNodeLocalUpdateDetail";
...
export function MainSequenceProjectDataNodeUpdatesTab({
      ...
      filteredLocalTimeSeries.length === 0 ? (
        <div className="px-5 py-14 text-center">
          ...
          <div className="mt-4 text-sm font-medium text-foreground">
            No data node updates found
          </div>
          <p className="mt-2 text-sm text-muted-foreground">
            This project has no matching LocalTimeSerie rows on the current page.
          </p>
        </div>
      ) : null}
