...
import {
  fetchKnativePodRuntimeLogs,
  formatMainSequenceError,
  type JobRunLogEntry,
} from "../../../../common/api";
import { MainSequenceRegistrySearch } from "../../../../common/components/MainSequenceRegistrySearch";

function mapPodRuntimeLogRowToEntry(row: JobRunLogEntry, index: number): LogTableEntry {
  ...
  return {
    ...
    children: Array.isArray(row.children)
      ? row.children.map((child, childIndex) => mapPodRuntimeLogRowToEntry(child, childIndex))
      : null,
  };
}
...
export function MainSequenceKnativePodRuntimeLogsTab({
  ...
  const filteredRows = useMemo(() => {
    ...
    const mappedRows = rows.map(mapPodRuntimeLogRowToEntry);
