...
function resolveLineStyle(lineStyle: DataNodeVisualizerLineStyle | undefined): "solid" | "dashed" | "dotted" {
  switch (lineStyle) {
    case "dashed":
    case "large_dashed":
      return "dashed";
...
function buildSeriesLegendData(series: readonly DataNodeVisualizerSeries[]) {
