...
- `YieldCurvePlotWidget.tsx`: widget renderer that turns the mock curve deck into a chart-only Lightweight Charts multi-line yield-curve plot.
- `YieldCurvePlotWidgetSettings.tsx`: typed widget settings for curve family, curve shape, and comparison stack.
