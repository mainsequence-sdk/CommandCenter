      ...
      <CardContent className="space-y-5">
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(260px,0.8fr)]">
          ...
          <div className="flex flex-wrap gap-2">
            <Badge variant="neutral">{String(publicConfig.feed ?? "iex")}</Badge>
            <Badge variant="neutral">{String(publicConfig.cryptoLocation ?? "us")}</Badge>
            <Badge variant="neutral">{String(publicConfig.defaultTimeframe ?? "1Min")}</Badge>
