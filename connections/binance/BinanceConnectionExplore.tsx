...
function buildDefaultQueryProps(input: {
  ...
  return {
    ...
    query: {
      ...
      kind: defaultQueryModel?.id ?? "binance-spot-prices",
    },
...
export function BinanceConnectionExplore({
  connectionInstance,
  connectionType,
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <CardTitle>Binance Market Data Explore</CardTitle>
        </div>
        <CardDescription>
      ...
      <CardContent className="space-y-5">
        ...
        <ConnectionQueryWorkbench
          ...
          resultDescription="Preview of the normalized Binance tabular frame returned by the backend adapter."
        />
      </CardContent>
    </Card>
  );
