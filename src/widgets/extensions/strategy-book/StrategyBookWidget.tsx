  ...
  const columnDefs = useMemo<ColDef<PositionRow>[]>(
    () => [
      { field: "symbol", headerName: "Symbol", minWidth: 110 },
      {
        ...
        headerName: "Side",
        minWidth: 90,
        cellClass: (params) => (params.value === "Long" ? "cell-positive" : "cell-negative"),
      },
      {
        field: "quantity",
        headerName: "Qty",
      ...
      },
      {
        ...
        headerName: "PnL",
        minWidth: 130,
        cellClass: (params) => ((params.value ?? 0) >= 0 ? "cell-positive" : "cell-negative"),
