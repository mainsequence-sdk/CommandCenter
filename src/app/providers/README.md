...
- Provider wiring must not trigger backend widget-catalog writes during normal sign-in. Widget registry publication is now an explicit admin settings action exposed through `SettingsDialog.tsx`.
