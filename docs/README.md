...
11. [ADR: Binding-Level Output Transforms for Structured Widget Outputs](./adr-binding-output-transforms.md)
12. [ADR: Executable Widget Graph Runner and Refresh Coordination](./adr-executable-widget-graph-runner.md)
13. [Workspace Runtime Performance Remediation](./workspace-runtime-performance-remediation.md)
14. [Configuration](./configuration.md)
15. [Internationalization](./internationalization.md)
16. [Extensions](./extensions.md)
17. [Theming](./theming.md)
18. [Backend and Auth Integration](./backend-and-auth.md)
19. [Deployment](./deployment.md)
20. [Notifications](./notifications.md)
21. [RBAC Assignment Matrix](./rbac-assignment-matrix.md)
22. [Access & RBAC App](./access-rbac-app.md)
